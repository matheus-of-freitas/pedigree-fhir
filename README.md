...
This markdown documentation layer is intentionally separate from the future Storybook-native docs site. Storybook remains a proof surface in this pass, not the primary written documentation system.
